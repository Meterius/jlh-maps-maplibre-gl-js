...
type RenderPass = "offscreen" | "opaque" | "translucent" | "composite";
type PainterOptions = {
...
export declare class Painter {
	...
	nextPresentOptions: PresentOptions | null;
	nextPresentInvalid: boolean;
	currentLayer: number;
	...
	_resizeRenderTargetFramebuffers(): void;
	_syncRenderTargetFramebuffers(requiredCount: number): void;
	bindRenderTargetFramebuffer(): void;
	_bindRenderTargetFramebufferIndex(index: number): void;
	_clearActiveRenderTarget(clearColor: Color): void;
	_clearRenderTargetFramebuffers(clearColor: Color): void;
	_isCompositeSeparatorLayer(layer: StyleLayer): boolean;
	_hasCompositeRender(layer: StyleLayer): boolean;
	_createPresentOptions(layerIds: string[], renderOptions: RenderOptions, forceRenderTarget: boolean): PresentOptions | null;
	_drawRenderTargetFramebuffer(framebuffer: Framebuffer): void;
	present(): void;
	clearStencil(): void;
...
type RenderCompositeHook = (transform: ITransform) => Promise<unknown>;
/**
...
declare class Map$1 extends Camera {
	...
	_renderCompositeHook: RenderCompositeHook | null;
	_renderCompositeHookNextId: number;
	_renderWithCompositeHookInProgress: boolean;
	_pendingRenderCompositeHookId: number | null;
	_pendingRenderCompositeHookRepaintRequested: boolean;
	/**
	 * @internal
	...
	* to unset glyphs.
	...
	_abortPendingRenderCompositeHookPresent(): void;
	_scheduleRenderCompositeHookPresent(renderCompositeHookPromise: Promise<unknown>): void;
	/**
	 * @internal
